...
window.BonusGames=(()=>{
 ...
 const ORDER=['zeichen','rombrennt','amphoren','katakomben','schildwall','tiber','wagen','kurier','circus'];
 const games={};
 const MILESTONES={zeichen:'conflict',rombrennt:'sources',amphoren:'cases',katakomben:'archive',schildwall:'map312',tiber:'vision',wagen:'change',kurier:'motives',circus:'bridge'};
